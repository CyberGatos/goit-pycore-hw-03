...
#була ідея вшити цикл всередені функції на except, але тоді доведеться, щоб функція викликала сама себе і мені здалося так простіше, якщо це весь функціонал